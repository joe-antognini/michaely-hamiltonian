...
int main(int argc, char *argv[])
{
	...
	const char *short_opts = "m:n:o:p:r:g:i:j:a:q:e:f:v:b:t:D:c:A:R:N:z:y:x:P:Q:S:T:U:k:s:dVh";
...
*/
	...
	hier.hier[hier.hi[1]+2].R = FB_REFF_BH * FB_CONST_G*m10/(FB_CONST_C*FB_CONST_C);
	hier.hier[hier.hi[1]+3].R = FB_REFF_BH * FB_CONST_G*m11/(FB_CONST_C*FB_CONST_C);
