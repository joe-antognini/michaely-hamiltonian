...
int fb_classify(fb_hier_t *hier, double t, double tidaltol, double speedtol, fb_units_t units, fb_input_t params)
{
  ...
  fb_dprintf("fewbody_classify: 36: nobj: %d\n", hier->nobj);
  ...
  fb_dprintf("fewbody_classify: 99: nobj: %d\n", hier->nobj);
  ...
  */
  ...
  fb_dprintf("fb_classify: before checking relative velocities\n");
  fb_dprintf("nobj: %d\n", hier->nobj);
